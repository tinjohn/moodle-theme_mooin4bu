moodle-theme_mooin4bu
==============================

[![Moodle Plugin CI](https://github.com/moodle-an-hochschulen/moodle-theme_mooin4bu/workflows/Moodle%20Plugin%20CI/badge.svg?branch=main)](https://github.com/moodle-an-hochschulen/moodle-theme_mooin4bu/actions?query=workflow%3A%22Moodle+Plugin+CI%22+branch%3Amain)
...
If you want to run your grandchild theme with a different name than theme_mooin4bu, for example theme_boost_union_foo, you have to take some actions:

* In the whole codebase of Boost Union Child below /theme/mooin4bu,
  * search all occurrences of 'mooin4bu' and replace them with 'boost_union_foo'
  * search all occurrences of 'Boost Union Child' and replace them with 'Boost Union Foo'
* In the language pack directory /theme/mooin4bu/lang,
  * rename the language pack file from en/theme_boost_union.php to en/theme_boost_foo.php
* In the tests directory /theme/mooin4bu/tests/behat,
  * rename the Behat step definition files from behat_theme_mooin4bu_behat_\*.php to behat_theme_boost_union_foo_behat_\*.php
...
* In the version file /theme/mooin4bu/version.php,
...
As an orientation how all these settings should look like, you can compare /theme/mooin4bu/version.php with /theme/boost_union/version.php, of course.
...
In the [extension-setting-scss-variable](https://github.com/moodle-an-hochschulen/moodle-theme_mooin4bu/tree/extension-setting-scss-variable) branch, we prepared some example code which shows you how allow the admin to configure a SCSS variable with an admin setting and without fiddling with SCSS.
...
In the [extension-modify-mustache-template](https://github.com/moodle-an-hochschulen/moodle-theme_mooin4bu/tree/extension-modify-mustache-template) branch, we prepared some example code which shows you how to modify a mustache template from Moodle core in Boost Union Child.
...
https://github.com/moodle-an-hochschulen/moodle-theme_mooin4bu
...
https://github.com/moodle-an-hochschulen/moodle-theme_mooin4bu/issues
...
https://github.com/moodle-an-hochschulen/moodle-theme_mooin4bu/pulls
