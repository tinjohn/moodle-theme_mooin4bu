...
$THEME->scss = function($theme) {
    return theme_mooin4bu_get_main_scss_content($theme);
};
$THEME->parents = ['boost_union', 'boost'];
$THEME->extrascsscallback = 'theme_mooin4bu_get_extra_scss';
$THEME->prescsscallback = 'theme_mooin4bu_get_pre_scss';
